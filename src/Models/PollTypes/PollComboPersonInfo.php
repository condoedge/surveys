...
class PollComboPersonInfo extends BasePollType
{
	...
	public static function createPollsCombo($surveyId, $pollSectionId, $position)
	{
		...
		$poll->body_po = translationsArr('surveys-input-name');
		$poll->explanation_po = __('surveys-input-name-exp');
		...
		$poll->type_po = PollTypeEnum::PO_TYPE_INPUT;
		$poll->body_po = translationsArr('surveys-input-email');
		$poll->explanation_po = __('surveys-input-email-exp');
		...
		$poll = static::initializePollForCombo($surveyId);
		$poll->type_po = PollTypeEnum::PO_TYPE_INPUT;
		$poll->body_po = translationsArr('surveys-input-phone');
		$poll->explanation_po = __('surveys-input-phone-exp');
		...
		$poll = static::initializePollForCombo($surveyId);
		$poll->type_po = PollTypeEnum::PO_TYPE_INPUT;
		$poll->body_po = translationsArr('surveys-input-address');
		$poll->explanation_po = __('surveys-input-address-exp');
